...
\begin{proof}
\par\smallskip\noindent\textit{The sequence for one prefix.}\quad
...
\par\smallskip\noindent\textit{Summing the prefixes and the Type-I remainder.}\quad
...
\par\smallskip\noindent\textit{The three-prime lower-sieve branch.}\quad
...
\par\smallskip\noindent\textit{The two-prime child upper sieve.}\quad
...
\par\smallskip\noindent\textit{Model integrals and scope.}\quad
